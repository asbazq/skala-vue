...
// 즐겨찾기로 선택한 도시의 id를 저장하는 반응형 상태 변수
...
// 즐겨찾기 목록이 바뀔 때 상태바에 현재 개수를 표시한다.
...
watchEffect(() => {
  console.log(
    `🤖 [watchEffect 자동 호출] 현재 검색어 '${searchQuery.value}'의 검색 결과는 ${filteredWeatherList.value.length}개입니다.`,
  )
})
